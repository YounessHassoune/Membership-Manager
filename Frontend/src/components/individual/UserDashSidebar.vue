<template>
  <div class="left-side">
    ...
    <svg
      ...
      stroke-linecap="round"
      stroke-linejoin="round"
      :class="activetab == 'myplans' ? 'active' : ''"
      @click="change('myplans')"
    >
    ...
    <svg
      viewBox="0 1 511 512"
      fill="currentColor"
      :class="activetab == 'getplans' ? 'active' : ''"
      @click="change('getplans')"
    >
      <path
    ...
    <svg viewBox="0 0 512 512" fill="currentColor" @click="logout">
      <path
